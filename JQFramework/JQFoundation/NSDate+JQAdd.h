 ...
 */
- (nullable NSDate *)JQ_dateByAddingYears:(NSInteger)years;
 ...
 */
- (nullable NSDate *)JQ_dateByAddingMonths:(NSInteger)months;
 ...
 */
- (nullable NSDate *)JQ_dateByAddingWeeks:(NSInteger)weeks;
 ...
 */
- (nullable NSDate *)JQ_dateByAddingDays:(NSInteger)days;
 ...
 */
- (nullable NSDate *)JQ_dateByAddingHours:(NSInteger)hours;
 ...
 */
- (nullable NSDate *)JQ_dateByAddingMinutes:(NSInteger)minutes;
 ...
 */
- (nullable NSDate *)JQ_dateByAddingSeconds:(NSInteger)seconds;
 ...
 */
- (nullable NSString *)JQ_stringWithFormat:(NSString *)format;
 ...
 */
- (nullable NSString *)JQ_stringWithISOFormat;
 ...
 */
+ (nullable NSDate *)JQ_dateWithString:(NSString *)dateString format:(NSString *)format;
...
/**
 ...
 If can not parse the string, returns nil.
 */
+ (nullable NSDate *)JQ_dateWithString:(NSString *)dateString
...
/**
 ...
 If can not parse the string, returns nil.
 */
+ (nullable NSDate *)JQ_dateWithISOFormatString:(NSString *)dateString;
