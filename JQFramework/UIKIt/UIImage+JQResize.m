...
@implementation UIImage (JQResize)

CGRect JQCGRectFitWithContentMode(CGRect rect, CGSize size, UIViewContentMode mode) {
...
- (void)drawInRect:(CGRect)rect withContentMode:(UIViewContentMode)contentMode clipsToBounds:(BOOL)clips{
    CGRect drawRect = JQCGRectFitWithContentMode(rect, self.size, contentMode);
